            ...
            <aside>
                <div className="call-to-action">
                    ...
                    <div className="package-content">
                        <header>
                           <span className="title"> <span className="price">{gig.price}$</span> + taxes & fees</span><br/>
                            <span className="sub-title">Save up to 20% with <span className="subscribe">Subscribe to Save</span></span>
                            <p>
                             <b>Standard Ad </b> 
                               I will turn your video into
                                a high-converting ad. Includes 
                                captions, b-roll, transitions and SFX.
                            </p>
                        </header>
                        <main>
                            <ul className="features">
                            <li><SvgIcon icon={'v'}/><span> Up to Unlimited minutes of footage provided</span></li>
                            <li><SvgIcon icon={'v'}/><span> Up to 1 minute running time</span></li>
                            <li><SvgIcon icon={'v'}/><span> Color grading</span></li>
                            <li><SvgIcon icon={'v'}/><span> Sound design & mixing</span></li>
                            <li><SvgIcon icon={'v'}/><span> Motion graphics</span></li>
                            <li><SvgIcon icon={'v'}/><span> Subtitles</span></li>    
                            </ul>
                        </main>
                        <footer>
                            <button className="continue-btn">Continue <span><SvgIcon icon={'rightArrow'}/></span></button>
                            <button className="contact-btn">Contact me<div><SvgIcon icon={'downArrow'}/></div></button>
